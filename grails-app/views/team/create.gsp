...
<html>
    <head>
        ...
        <title><g:message code="team.create.label" /></title>
    </head>
    <body>
        ...
        <div class="nav" role="navigation">
            <ul>
                ...
                <li><g:link class="list" action="index"><g:message code="team.list.label" /></g:link></li>
            </ul>
        </div>
        <div id="create-team" class="content scaffold-create" role="main">
            <h1><g:message code="team.create.label" /></h1>
